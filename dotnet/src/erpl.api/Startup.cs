...
public class Startup
{
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        services.AddMediatR(cfg => cfg.RegisterServicesFromAssemblies(
            typeof(CreateWiretapProcessor).GetTypeInfo().Assembly,
            typeof(GetWiretapByIdProcessor).GetTypeInfo().Assembly,
            typeof(GetWiretapsProcessor).GetTypeInfo().Assembly,
            typeof(UpdateWiretapProcessor).GetTypeInfo().Assembly,
            typeof(DeleteWiretapProcessor).GetTypeInfo().Assembly
        ));
    }
